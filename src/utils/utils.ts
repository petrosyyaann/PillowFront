...
export function makeSuggestHandsApartWithLine(
  ...
  // Новая ошибка
  if ((lElbowX >= lShoulderX + line) || (rElbowX <= rShoulderX - line)) {
    //console.log('Ошибка: Старайтесь не отводить локти. Левый локоть:', lElbowX, 'Правый локоть:', rElbowX)
    suggest = 'Старайтесь не отводить локти'
  }

  if (((lAngle < 120) || (rAngle < 120)) && suggest === '') {
    suggest = 'Старайтесь не сгибать руки'
  }
